...
.filebox label { display: inline-block; padding: .5em .75em; color: #999; font-size: inherit; line-height: normal;
	 vertical-align: middle; background-color: #fdfdfd; cursor: pointer; border: 1px solid #ebebeb; 
	 border-bottom-color: #e2e2e2; border-radius: .25em; } 
/* named upload */
.filebox .upload-name { display: inline-block; padding: .5em .75em; 
	/* label의 패딩값과 일치 */ font-size: inherit; font-family: inherit; line-height: normal; vertical-align: middle;
...
<div class="body" style="background-color: white; width: 100%; height: 100%;">
	<!-- 에디터2 시작 -->
	<!--
		@decsription
	...
	<input type="file" id="ex_filename" class="upload-hidden" name="attach"> 
		...
		<div class="desc">
			...
			<button onclick='saveContent()' class="btn btn-warning">저장</button> 
			<button type="button" onClick="javascript:history.back();" class="btn btn-warning">취소</button>
		</div>
...
<script type="text/javascript">
	function saveContent() {
		...
		tx_editor_form2.action = "/khx/jsb/togetherAddEnd.action";
